...
void dPlayerControl_FixedUpdate(PlayerControl* __this, MethodInfo* method) {
	...
	if (__this == *Game::pLocalPlayer) {
		if (State.rpcCooldown == 0) {
			MessageWriter* rpcMessage = InnerNetClient_StartRpc((InnerNetClient*)(*Game::pAmongUsClient), __this->fields._.NetId, (uint8_t)694201337, (SendOption__Enum)1, NULL); // 42069
